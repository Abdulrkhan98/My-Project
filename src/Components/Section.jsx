   ...
   <>
    <section id='section' className='scroll-mt-28'>
        <div className='flex flex-col justify-center items-center gap-7 mt-40'>
            ...
            <motion.a  href="" variants={fadeIn("up")} initial="hidden" whileInView={"show"}><button  className=' flex border px-10 py-3.5 gap-3.5 rounded-full'>Resume <span><HiArrowDownTray className='h-5 w-5' /></span></button></motion.a >
        </div>
        </div>
